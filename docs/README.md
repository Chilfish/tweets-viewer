...
> **AI 指令**：在进行任何代码生成、架构设计或逻辑重构之前，请务必阅读以下文档。

## 核心文档

### 1. [功能规格说明书 (Specification)](./Specification.md)
...
- **技术栈**：Bun 1.3, React 19, React Router v7 (SSR), Tailwind CSS v4, Base UI/COSS, Zustand v5, Hono v4, Drizzle ORM, Cloudflare Workers, Neon Postgres
